...
void cVisibleApp::setLightDirection( Vec3f direction )
{
...
void cVisibleApp::setup()
{
    ...
    std::function<void( Vec3f )> setter	= std::bind( &cVisibleApp::setLightDirection, this, std::placeholders::_1 );
    std::function<Vec3f ()> getter		= std::bind( &cVisibleApp::getLightDirection, this );

...
void CVisibleApp::addActiveMovie( qtime::MovieGl movie )
{
...
void CVisibleApp::loadMovieUrl( const string &urlString )
{
	try {
...
void CVisibleApp::drawFFT( const qtime::MovieBase &movie, float x, float y, float width, float height )
{

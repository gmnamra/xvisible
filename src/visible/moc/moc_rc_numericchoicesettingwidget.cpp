...
void rcNumericChoiceSettingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcNumericChoiceSettingWidget *_t = static_cast<rcNumericChoiceSettingWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData rcNumericChoiceSettingWidget::staticMetaObjectExtraData = {
...
const QMetaObject rcNumericChoiceSettingWidget::staticMetaObject = {
    { &rcSettingWidget::staticMetaObject, qt_meta_stringdata_rcNumericChoiceSettingWidget,
      qt_meta_data_rcNumericChoiceSettingWidget, &staticMetaObjectExtraData }
};

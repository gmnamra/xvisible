...
void rcTextChoiceSettingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcTextChoiceSettingWidget *_t = static_cast<rcTextChoiceSettingWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData rcTextChoiceSettingWidget::staticMetaObjectExtraData = {
...
const QMetaObject rcTextChoiceSettingWidget::staticMetaObject = {
    { &rcSettingWidget::staticMetaObject, qt_meta_stringdata_rcTextChoiceSettingWidget,
      qt_meta_data_rcTextChoiceSettingWidget, &staticMetaObjectExtraData }
};

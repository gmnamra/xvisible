...
void dump(dump_context& context, const std::vector<bool>& data) throw(persistent_dump_failed)
{
...
void restore(restore_context& context, std::vector<bool>& data) throw(persistent_restore_failed)
{
  size_t size = 0;
  restore(context,size);
  data.resize(size);

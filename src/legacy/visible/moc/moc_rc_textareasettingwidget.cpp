...
void rcTextAreaSettingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcTextAreaSettingWidget *_t = static_cast<rcTextAreaSettingWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData rcTextAreaSettingWidget::staticMetaObjectExtraData = {
...
const QMetaObject rcTextAreaSettingWidget::staticMetaObject = {
    { &rcSettingWidget::staticMetaObject, qt_meta_stringdata_rcTextAreaSettingWidget,
      qt_meta_data_rcTextAreaSettingWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rcTextAreaSettingWidget::getStaticMetaObject() { return staticMetaObject; }

...
void rcTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcTextEdit *_t = static_cast<rcTextEdit *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData rcTextEdit::staticMetaObjectExtraData = {

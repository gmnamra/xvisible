...
void rcTrackManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcTrackManager *_t = static_cast<rcTrackManager *>(_o);
        switch (_id) {
        case 0: _t->trackhighlighted(); break;
        case 1: _t->updateState((*reinterpret_cast< rcExperimentState(*)>(_a[1]))); break;
        case 2: _t->addTracks(); break;
        case 3: _t->setColors(); break;
        case 4: _t->rebuildTracks(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData rcTrackManager::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject rcTrackManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_rcTrackManager,
      qt_meta_data_rcTrackManager, &staticMetaObjectExtraData }
};

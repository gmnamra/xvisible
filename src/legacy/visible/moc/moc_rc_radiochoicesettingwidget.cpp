...
void rcRadioChoiceSettingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcRadioChoiceSettingWidget *_t = static_cast<rcRadioChoiceSettingWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData rcRadioChoiceSettingWidget::staticMetaObjectExtraData = {
...
const QMetaObject rcRadioChoiceSettingWidget::staticMetaObject = {
    { &rcSettingWidget::staticMetaObject, qt_meta_stringdata_rcRadioChoiceSettingWidget,
      qt_meta_data_rcRadioChoiceSettingWidget, &staticMetaObjectExtraData }
};

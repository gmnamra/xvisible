...
void rcTextLineSettingWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        rcTextLineSettingWidget *_t = static_cast<rcTextLineSettingWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData rcTextLineSettingWidget::staticMetaObjectExtraData = {
...
const QMetaObject rcTextLineSettingWidget::staticMetaObject = {
    { &rcSettingWidget::staticMetaObject, qt_meta_stringdata_rcTextLineSettingWidget,
      qt_meta_data_rcTextLineSettingWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &rcTextLineSettingWidget::getStaticMetaObject() { return staticMetaObject; }

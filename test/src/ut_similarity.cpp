...
uint32 UT_similarity_producer::run ()
{
    ...
    errors += test (mQTInputMovie) ? 1 : 0; // expect Quicktime import to fail
    return errors;
}
...
void UT_similarity::testPerformance(uint32 size, vector<rcWindow>& images)
{
    ...
    rcSimilarator::rcMatrixGeneration type = rcSimilarator::eExhaustive;

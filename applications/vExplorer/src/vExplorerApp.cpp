...
#include "v_explorer.h"
using namespace ci;
using namespace ci::app;

class vExplorerApp : public AppBasic {
 public:
	void    setup();
	void    resize();
...
void vExplorerApp::setup()
{
 //   gl_format_string_from_numeric::instance();
...
void vExplorerApp::mouseDown( MouseEvent event )
{
    mArcball.mouseDown( event.getPos() );
}

void vExplorerApp::mouseDrag( MouseEvent event )
{
    mArcball.mouseDrag( event.getPos() );
}

void vExplorerApp::keyDown( KeyEvent event )
{
...
void vExplorerApp::updateData( vExplorerApp::ColorSwitch whichColor )
{
...
CINDER_APP_BASIC( vExplorerApp, RendererGl );

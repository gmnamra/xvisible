...
void hash_iterator<K,T,H,E,V>::chk_owner(const hash<K,T,H,E>* owner) const
  throw(wrong_object)
{
  if (owner != m_owner)
...
template<typename K, typename T, class H, class E, typename V>
void hash_iterator<K,T,H,E,V>::chk_non_null(void) const
...
template<typename K, typename T, class H, class E, typename V>
void hash_iterator<K,T,H,E,V>::chk_non_end(void) const
...
template<typename K, typename T, class H, class E, typename V>
void hash_iterator<K,T,H,E,V>::chk_valid(void) const
...
template<typename K, typename T, class H, class E, typename V>
void hash_iterator<K,T,H,E,V>::chk(const hash<K,T,H,E>* owner) const
...
std::pair<TEMPLATE_TYPENAME hash<K,T,H,E>::iterator, bool> hash<K,T,H,E>::insert(const std::pair<const K,T>& value)
{
  ...
  {
    // first chk the full stored hash value
  ...
  return std::make_pair(hash<K,T,H,E>::iterator(this,hash_value,new_item), inserted);
}

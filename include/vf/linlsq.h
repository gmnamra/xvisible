...
class LLSQ
{
 public:
  ...
  // covariance matrix.
  rc2Fvector vector_fit() const;
  rcRadian vector_fit_angle () const;
...
template<typename T> T MedianOfCircularValues(T modulus, std::vector<T>* v) {
  LLSQ stats;

...
QMAKE    = /usr/bin/qmake
visible_qt_moc.xcodeproj/project.pbxproj: visible_qt_moc.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.8/mkspecs/macx-xcode -o visible_qt_moc.xcodeproj/project.pbxproj visible_qt_moc.pro
